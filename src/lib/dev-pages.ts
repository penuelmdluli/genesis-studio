...
export const DEV_PAGES: Record<string, DevPageConfig> = {
  ...
  tech_pulse_africa: {
    ...
    // Added breaking_news so tech pages also cover major world events
    content_pillars: ["ai_news", "tech", "ai_disruption", "breaking_news"],
    engine: "wan-2.2",
    premium_engine: "wan-2.2",
    post_times: ["09:00", "14:00", "19:00"],
    watermark: false,
    caption_style: "tech_shock",
    hashtags: ["#TechPulseAfrica", "#AITech", "#Innovation", "#BreakingNews", "#Trending"],
    enabled: true,
  ...
  pop_culture_buzz: {
    ...
    content_pillars: ["entertainment", "celebrity", "viral_moments", "breaking_news"],
    engine: "wan-2.2",
    premium_engine: "wan-2.2",
    post_times: ["10:00", "15:00", "20:00"],
    watermark: false,
    caption_style: "entertainment_hook",
    hashtags: ["#PopCulture", "#Entertainment", "#CelebNews", "#Trending", "#Viral"],
    enabled: true,
  ...
  ai_revolution: {
    ...
    watermark: false,
    caption_style: "tech_shock",
    hashtags: ["#AIRevolution", "#AI", "#FutureOfWork", "#TechNews", "#Breaking"],
    enabled: true,
