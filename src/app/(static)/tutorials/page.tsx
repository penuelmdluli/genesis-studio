...
export const metadata = {
  title: "Tutorials — iVideo Studio",
  description: "Learn how to create amazing AI videos with iVideo Studio.",
};
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-24">
        ...
        <p className="text-zinc-400 mb-12">Learn how to get the most out of iVideo Studio.</p>
        ...
        <div className="grid gap-6">
          {[
            ...
            { title: "Using the API", desc: "Generate videos programmatically with the iVideo Studio REST API.", link: "/docs" },
          ].map((tut) => (
