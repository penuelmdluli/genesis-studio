  ...
  return (
    <PageTransition className="space-y-6">
          ...
          {keys.length === 0 ? (
            <div className="text-center py-10 relative">
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-white/[0.04] border border-white/[0.10] flex items-center justify-center mx-auto mb-4">
            ...
            <div className="space-y-2">
              {keys.map((key) => (
                <div
                  key={key.id}
                  className="flex items-center gap-4 p-3 rounded-xl border border-white/[0.10] bg-white/[0.04] hover:bg-white/[0.04] transition-colors"
                >
      ...
      <Card>
        ...
        <CardContent>
          {/* Language tabs */}
          <div className="flex gap-1 mb-3 p-0.5 rounded-lg bg-white/[0.05] border border-white/[0.10] w-fit">
          ...
          <div className="rounded-xl bg-[#0D0D14] border border-white/[0.04] overflow-hidden">
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-white/[0.04]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-zinc-400">{codeExamples[activeTab].lang}</span>
              </div>
              <button
                onClick={() => {
