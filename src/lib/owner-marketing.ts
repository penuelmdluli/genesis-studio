...
export const SA_CHARACTER_PRESETS: CharacterPreset[] = [
  {
    id: "zulu-princess",
    name: "Zulu Princess",
    prompt: "Photorealistic full body photo of an adorable 3-year-old South African Zulu baby girl standing in a confident dance-ready pose, entire body visible from head to tiny feet, radiant dark melanin-rich skin with natural glow, big bright sparkling brown eyes, wearing authentic colorful Zulu beaded headpiece and intricate beaded necklace in red gold and turquoise, vibrant red and gold traditional outfit with detailed beadwork, tiny beaded anklets on bare feet, joyful beaming smile, full length shot, clean studio background, professional photography lighting, 8K hyperrealistic",
    tags: ["zulu", "traditional", "girl"],
  },
  {
    id: "xhosa-prince",
    name: "Xhosa Prince",
    prompt: "Photorealistic full body photo of a charming 4-year-old South African Xhosa baby boy standing with hands on hips in a playful pose, entire body visible from head to shoes, rich dark brown skin with natural glow, bright smile showing tiny teeth, wearing modern Xhosa-inspired outfit with traditional ochre and white geometric patterns, small beaded cap, fresh white sneakers, full length shot from head to toe, clean background, warm studio lighting, 8K hyperrealistic",
    tags: ["xhosa", "traditional", "boy"],
  },
  {
    id: "ndebele-star",
    name: "Ndebele Star",
    prompt: "Photorealistic full body photo of a stunning 3-year-old South African Ndebele baby girl standing proudly with arms slightly out in a dance pose, entire body visible from head to feet, beautiful deep melanin skin, wearing authentic Ndebele-inspired outfit with bold geometric patterns in electric blue canary yellow cherry red and emerald green, colorful beaded ankle bracelets, bare feet, proud happy expression, full length shot, clean background, professional lighting, 8K hyperrealistic",
    tags: ["ndebele", "colorful", "girl"],
  },
  {
    id: "township-kid",
    name: "Township Kid",
    prompt: "Photorealistic full body photo of an irresistibly cool 4-year-old South African township baby boy standing in a boss pose with arms crossed, entire body visible from head to fresh sneakers, smooth dark skin, cheeky grin, wearing trendy streetwear — brand new tiny Air Jordan sneakers, tilted bucket hat, colorful puffer jacket in SA flag green and gold, miniature gold chain necklace, baggy jeans, full length shot from head to toe, clean background, golden hour lighting, 8K hyperrealistic",
    tags: ["urban", "streetwear", "boy"],
  },
  {
    id: "amapiano-queen",
    name: "Amapiano Queen",
    prompt: "Photorealistic full body photo of a dazzling 3-year-old South African baby girl in a sassy dance pose with one hand on hip, entire body visible from head to sparkly shoes, glowing dark skin, wearing sparkling sequin mini dress in rose gold and hot pink, tiny designer sunglasses pushed up on forehead, miniature gold hoop earrings, sparkly pink shoes, full length shot, clean dark background with subtle pink and purple bokeh, professional lighting, 8K hyperrealistic",
    tags: ["amapiano", "party", "girl"],
  },
  {
    id: "gqom-king",
    name: "Gqom King",
    prompt: "Photorealistic full body photo of an impossibly cool 4-year-old South African Durban baby boy standing in a power stance with arms crossed, entire body visible from head to gold-accent sneakers, dark skin with dramatic lighting, wearing sleek all-black outfit with gold zipper accents and gold chain, fresh black and gold tiny sneakers, confident smirk, full length shot from head to toe, clean dark background with subtle neon cyan accents, editorial fashion lighting, 8K hyperrealistic",
    tags: ["gqom", "durban", "boy"],
  },
  {
    id: "rainbow-nation",
    name: "Rainbow Nation Baby",
    prompt: "Photorealistic full body photo of a beautiful 3-year-old mixed-race South African baby standing with arms outstretched joyfully, entire body visible from curly hair to colorful shoes, gorgeous curly afro hair with tiny colorful ribbons in SA flag colors, wearing a bright rainbow tutu dress layered with all six flag colors, colorful sneakers, holding a miniature South African flag, enormous proud smile, full length shot, clean light background, warm golden lighting, 8K hyperrealistic",
    tags: ["rainbow", "patriotic", "unisex"],
  },
  {
    id: "safari-explorer",
    name: "Safari Explorer",
    prompt: "Photorealistic full body photo of an adventurous 4-year-old South African baby standing in an explorer pose pointing forward, entire body visible from pith helmet to boots, wearing adorable safari explorer outfit with tiny khaki vest many pockets cargo shorts and little hiking boots, miniature pith helmet, oversized binoculars around neck, curious excited expression, full length shot from head to boots, clean warm-toned background, golden hour lighting, 8K hyperrealistic",
    tags: ["safari", "adventure", "unisex"],
  },
  {
    id: "soweto-dancer",
    name: "Soweto Dancer",
    prompt: "Photorealistic full body photo of a dynamic 3-year-old South African baby mid-dance-move with arms spread wide and one foot lifted, entire body visible from head to fresh sneakers, dark skin glistening with energy, wearing colorful African print outfit with modern streetwear fusion and fresh dance sneakers, huge joyful laughing expression, full length action shot, clean background, dynamic lighting with rim light, 8K hyperrealistic",
    tags: ["dance", "soweto", "unisex"],
  },
  {
    id: "tech-prodigy",
    name: "Tech Prodigy",
    prompt: "Photorealistic full body photo of a focused 4-year-old South African baby standing confidently holding a tiny tablet, entire body visible from head to clean sneakers, wearing miniature round glasses and smart casual outfit with tiny blazer jeans and clean white sneakers, one hand holding glowing tablet, serious concentrated expression, full length shot, clean futuristic dark background with subtle teal ambient glow, professional lighting, 8K hyperrealistic",
