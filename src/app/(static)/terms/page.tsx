...
export const metadata = {
  title: "Terms of Service — iVideo Studio",
  description: "iVideo Studio terms of service and usage agreement.",
};
      ...
      <main className="max-w-3xl mx-auto px-4 py-24">
        ...
        <div className="space-y-6 text-zinc-300 leading-relaxed text-sm">
          <section>
            ...
            <p>By accessing or using iVideo Studio (&ldquo;the Platform&rdquo;), you agree to be bound by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree, do not use the Platform. These Terms constitute a legally binding agreement between you and iVideo Studio.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">2. Eligibility</h2>
            <p>You must be at least 13 years old to use iVideo Studio. If you are under 18, you must have parental or guardian consent. By using the Platform, you represent that you meet these requirements.</p>
          </section>
          ...
          <section>
            ...
            <p>You retain full ownership of content you create using iVideo Studio. By publishing content to the Explore feed, you grant iVideo Studio a non-exclusive, worldwide, royalty-free license to display, distribute, and promote your content on the Platform. You may remove published content at any time, which revokes this license.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">7. Acceptable Use Policy</h2>
            <p className="mb-2">You may not use iVideo Studio to create, upload, or distribute content that:</p>
            <ul className="list-disc list-inside space-y-1 text-zinc-400">
          ...
          <section>
            ...
            <p className="mb-2">We respect intellectual property rights. If you believe content on iVideo Studio infringes your copyright, submit a DMCA takedown notice to <a href="mailto:hello@ivideostudio.ai" className="text-violet-400 hover:text-violet-300">hello@ivideostudio.ai</a> with:</p>
            <ul className="list-disc list-inside space-y-1 text-zinc-400">
          ...
          <section>
            ...
            <p>All videos created on iVideo Studio are generated by artificial intelligence. Users are responsible for disclosing that content is AI-generated when required by applicable laws or platform policies (e.g., when posting to social media). iVideo Studio watermarks free-tier content to identify it as AI-generated.</p>
          </section>
          ...
          <section>
            ...
            <p>iVideo Studio is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any kind, express or implied. To the maximum extent permitted by law, iVideo Studio shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill.</p>
          </section>
