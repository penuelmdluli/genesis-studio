        ...
        <section className="max-w-4xl mx-auto px-4 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            {video.duration && video.duration > 0 && (
              <span className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-white/[0.05] text-zinc-400 text-xs font-medium border border-white/[0.10]">
            ...
            {/* Resolution */}
            {video.resolution && (
              <span className="px-2.5 py-1 rounded-lg bg-white/[0.05] text-zinc-400 text-xs font-medium border border-white/[0.10]">
                {video.resolution}
              </span>
            )}
